                    ...
                    <table class="table table-sm table-bordered border-secondary" id="example" style="table-layout: fixed">
                        <thead class="border-secondary">
                            <tr>
                                ...
                                <th scope="col" class="text-center">Tiempo Reparación</th>
                                <th scope="col" class="text-center">Estado Orden-Falla</th>
        ...
        const datatable = $('#example').DataTable({
            ...
            columns: [{
                    ...
                    createdCell: function(td, cellData, rowData, row, col) {
                        $(td).addClass('fw-bold fs-5 border-secondary')
                ...
                },
                {
                    ...
                    render: (data, type, row, meta) => `
                        <span>Hrs Estimadas:</span> ${row.falla_tiempo_hh_estimado}
                        <br>
                        <span>Hrs Reales:</span> ${row.falla_tiempo_hh_estimado}
                    `
                },
                {
                    data: 'orden_estatus',
