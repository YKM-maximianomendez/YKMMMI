            ...
            <div class="card border-secondary">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h3 class="fw-bolder">
                            <strong>Clasificación de Fallas</strong>
                        </h3>

                        <div>
                            <button type="button" class="btn btn-outline-primary fw-bold me-1" id="clasificacionfalla-create">
                    ...
                    <table class="table table-sm border-secondary table-striped table-bordered w-100" id="example" style="table-layout: fixed">
...
@include('catalogos.clasificaciones-falla.formulario')
@endsection
@section('scripts')
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', () => {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: () => {
                        return `
                            <div>
                                <span role="button" class="clasificacionfalla-edit me-2">
                                ...
                                <span role="button" class="clasificacionfalla-destroy">
        ...
        $(document).on('click', '#clasificacionfalla-create', () => {
            this.dispatchEvent(new CustomEvent('clasificacionfalla-create'))
        })

        $(document).on('click', '.clasificacionfalla-edit', (e) => {
            this.dispatchEvent(new CustomEvent('clasificacionfalla-edit', {
                detail: {
        ...
        $(window).on('clasificacionfalla-success', (e) => {
            Swal.fire({
                icon: 'success',
