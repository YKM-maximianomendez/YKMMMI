...
<div class="container-fluid">
            ...
            <div class="card border-secondary">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h3 class="fw-bolder">
                            <strong>Causas Fallas</strong>
                        </h3>

                        <div>
                            <button type="button" class="btn btn-outline-primary fw-bold me-1" id="causafalla-create">
    ...
    @include('catalogos.causas-falla.formulario')
</div>
@endsection
@section('scripts')
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', () => {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: () => {
                        return `
                                <div>
                                    <span role="button" class="causafalla-edit me-2">
                                    ...
                                    <span role="button" class="causafalla-destroy">
        ...
        $(document).on('click', '#causafalla-create', () => {
            this.dispatchEvent(new CustomEvent('causafalla-create'))
        })

        $(document).on('click', '.causafalla-edit', (e) => {
            this.dispatchEvent(new CustomEvent('causafalla-edit', {
                detail: {
        ...
        $(window).on('causafalla-success', (e) => {
            Swal.fire({
                icon: 'success',
