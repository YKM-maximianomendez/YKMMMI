<div class="offcanvas offcanvas-start" tabindex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="staticBackdropLabel">Filtros de búsqueda</h5>
            ...
            <form id="filtros">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="fecha_emision_inicio" value="{{ now()->startOfMonth()->toDateString() }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="fecha_emision_fin" class="form-label"><i class="fa fa-calendar-alt"></i> Fecha de Fin</label>
                        <input type="date" class="form-control" id="fecha_emision_fin" value="{{ now()->endOfMonth()->toDateString() }}" required>
                    </div>
                </div>
                <div class="row g-3">
                    <div class="col-md-12">
